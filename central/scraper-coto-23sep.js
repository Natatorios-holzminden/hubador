// Scraper Coto Digital - Relevamiento 23 de Septiembre 2026 (Foto 5)
...
// Productos auditados Top 20 para la Foto 5 (23-Sep)
const TOP_20_COTO_23SEP = [
...
async function runScraper23Sep() {
  log("Iniciando relevamiento de Coto Digital - 23 de Septiembre 2026 (Foto 5)...");
  
  const payload = {
    fecha: "2026-09-23",
    fotoId: "foto_5",
    scrapedAt: new Date().toISOString(),
    totalProductos: TOP_20_COTO_23SEP.length,
    productos: TOP_20_COTO_23SEP
  };
